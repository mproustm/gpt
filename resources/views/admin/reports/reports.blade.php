{{-- resources/views/admin/reports/reports.blade.php --}}
...
@section('content')
    ...
    <div class="d-flex flex-wrap align-items-center gap-2 mb-3">
        ...
        <div class="dropdown export-print ms-auto">
            <button class="btn btn-primary btn-sm d-flex align-items-center gap-1"
                ...
                <i class="fa-solid fa-chevron-down small flex-shrink-0"></i>
            </button>
            ...
            <ul class="dropdown-menu shadow-sm rounded-3" aria-labelledby="exportMenu">
                ...
                <li>
                    <a href="#" class="dropdown-item print-option" data-target="all" title="Ctrl + P">
                        <i class="fa-solid fa-print fa-fw"></i> طباعة الكل
                    </a>
                </li>
                <li>
                    <a href="#" class="dropdown-item print-option" data-target="finance-section">
                        <i class="fa-solid fa-hand-holding-dollar fa-fw"></i> تقرير مالي
                    </a>
                </li>
                <li>
                    <a href="#" class="dropdown-item print-option" data-target="clients-section">
                        <i class="fa-solid fa-users fa-fw"></i> تقرير العملاء
                    </a>
                </li>
                ...
                <li>
                    <a href="#" id="exportPDF" class="dropdown-item">
                        <i class="fa-solid fa-file-pdf text-danger fa-fw"></i> PDF (الجدول السنوي)
                    </a>
                </li>
            </ul>
        </div>
    ...
    <div class="row" data-printable>
        ...
        <div class="col-md-4">
            <div class="stats-card">
                ...
                <div>
                    <span class="stats-label">الملاعب</span>
    ...
    <section id="finance-section" class="mt-4" data-printable>
        <div class="row">
            ...
            {{-- تمت إزالة المصروفات والربح حسب الطلب --}}
        </div>
        ...
        <div class="row mt-3">
            ...
            {{-- تمت إزالة "التدفق النقدي" --}}
        </div>
    </section>

    <!-- قسم العملاء -->
    <section id="clients-section" class="mt-4" data-printable>
        {{-- تمت إزالة "مصادر الإيراد" و "أفضل 5 عملاء" --}}
        <div class="content-box">
...
@push('scripts')
    ...
    document.addEventListener('DOMContentLoaded', async function () {
        ...
        const dataUrl       = "{{ route('admin.reports.data') }}";
        ...
        // التصدير: Excel و PDF للجدول السنوي
